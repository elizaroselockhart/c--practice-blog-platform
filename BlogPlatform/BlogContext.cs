...
namespace BlogPlatform
{
    public class BlogContext:DbContext
    {
        ...
        {
            var connectionString = @"Server=(localdb)\mssqllocaldb; Database=BASED_DATABASE; Trusted_Connection=True";
